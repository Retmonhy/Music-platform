//libraties
import React, { FC, useState, MouseEvent, useContext, HTMLAttributes } from 'react';
...
import { useAppDispatch, useAction, useIsMobile, useTypedSelector } from '@shared/hooks';
import { generateUrl, merge } from '@shared/lib';
import { usePlaylistContext } from '../../lib/hooks';
