...
import { AccountRoutes, H1, ILoginData, IRegistrationData, RegistrationModes, TabPanelProps } from '@shared';
...
const AuthPage = () => {
	...
	//functions
	const handleChange = (event: React.SyntheticEvent, newValue: RegistrationModes) => {
		setMode(newValue);
	};
		...
		<Box maxWidth={600} margin='0 auto' pt={4}>
			...
			<Card>
				<Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
					<Tabs variant='fullWidth' value={mode} onChange={handleChange} aria-label='auth tabs'>
						<Tab className='auth-tab' label={Local.Account.Registration} value={RegistrationModes.REG} />
						<Tab className='auth-tab' label={Local.Account.Login} value={RegistrationModes.LOGIN} />
					</Tabs>
