...
import { AccountRoutes, ControlledInput, IRegistrationData, useAction, useTypedSelector, Toast } from '@shared';
	...
	return (
		<>
			...
			<Box
				...
				<Link href='#' underline='always' color={vars.dangerColor} onClick={logoutHandler}>
